...
key_size_dsa = int(input("Enter DSA key size in bits (maximum 3072 bits) (80=1024, 112=2048, 128=3072): "))
...
print("Available curves: SECP192R1,SECP224R1 SECP256R1, SECP384R1, SECP521R1")
...
print(f"RSA Sign Time: {after_sign - before_sign:.6f} seconds")
...
print(f"RSA Verify Time: {after_verify - before_verify:.6f} seconds")
...
after_sign = time.perf_counter()
print(f"DSA Sign Time: {after_sign - before_sign:.6f} seconds")
...
after_verify = time.perf_counter()
print(f"DSA Verify Time: {after_verify - before_verify:.6f} seconds")
...
after_sign = time.perf_counter()
print(f"ECC Sign Time: {after_sign - before_sign:.6f} seconds")
...
after_verify = time.perf_counter()
print(f"ECC Verify Time: {after_verify - before_verify:.6f} seconds")
